...
- README ini mendeskripsikan kondisi repo saat ini, bukan lagi sekadar landing page foundation.

## Next Step Yang Masuk Akal

Prioritas pengembangan berikut yang paling realistis:

1. Tambahkan test untuk flows penting: auth, onboarding, invoice CRUD.
2. Rapikan analytics agar berbasis data nyata per periode.
3. Tambahkan email template production-grade dan verified sender domain.
4. Tambahkan PDF export server-side bila butuh output yang konsisten.
5. Siapkan billing/subscription jika produk akan dijual publik.
